...
// Credit to Jacob Goodwin for this middleware: GitHub: https://github.com/JacobSNGoodwin, Youtube: https://www.youtube.com/@jacobocode5654
...
// or has already written its header to prevent header and body overwrites
